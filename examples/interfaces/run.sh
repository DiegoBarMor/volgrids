...
overlap $fp2n/prot.stk.bin $fp2n/rna.stk.og.bin $fp2n/p2n.stk.bin
overlap $fp2n/prot.hba.bin $fp2n/rna.hba.og.bin $fp2n/p2n.hbd.bin
overlap $fp2n/prot.hbd.bin $fp2n/rna.hbd.og.bin $fp2n/p2n.hba.bin

overlap $fn2p/rna.stk.bin $fn2p/prot.stk.og.bin $fn2p/n2p.stk.bin
overlap $fn2p/rna.hba.bin $fn2p/prot.hba.og.bin $fn2p/n2p.hbd.bin
overlap $fn2p/rna.hbd.bin $fn2p/prot.hbd.og.bin $fn2p/n2p.hba.bin
...
pack $fp2n/prot.stk.bin    $fp2n/prot.hbd.bin    $fp2n/prot.hba.bin    $fdata/prot.cmap
pack $fp2n/rna.stk.og.bin  $fp2n/rna.hba.og.bin  $fp2n/rna.hbd.og.bin  $fdata/rna.og.cmap
pack $fn2p/rna.stk.bin     $fn2p/rna.hbd.bin     $fn2p/rna.hba.bin     $fdata/rna.cmap
