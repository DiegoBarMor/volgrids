...
from src.tables import ww_scale, nucleic_bases, nucleic_backbone_phosphate, nucleic_backbone_sugar
...
class SPG_Hydrophilic(SPG_Hydro):
    ...
    def populate_grid(self):
        ...
        gk_hphil = GaussianKernel(MU_HYDROPHILIC, SIGMA_HYDROPHILIC, radius_hphil, self.ms.deltas, np.float32)
...
class SPG_Hydrophobic(SPG_Hydro):
    ...
    def populate_grid(self):
        ...
        gk_hphob = GaussianKernel(MU_HYDROPHOBIC, SIGMA_HYDROPHOBIC, radius_hphob, self.ms.deltas, np.float32)
