...
grid_mrc = vg.read_mrc(PATH_MRC_ORIG)
vg.write_mrc(PATH_MRC_TO_MRC, grid_mrc)
vg.write_dx(PATH_MRC_TO_DX, grid_mrc)

print(f"...>>> Converting {PATH_DX_ORIG}")
grid_dx = vg.read_dx(PATH_DX_ORIG)
vg.write_mrc(PATH_DX_TO_MRC, grid_dx)
vg.write_dx(PATH_DX_TO_DX, grid_dx)
