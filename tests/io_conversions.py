...
grid_mrc = vp.Grid.from_mrc(PATH_MRC_ORIG)
grid_mrc.write_mrc(PATH_MRC_TO_MRC)
grid_mrc.write_dx(PATH_MRC_TO_DX)

grid_dx = vp.Grid.from_dx(PATH_DX_ORIG)
grid_dx.write_mrc(PATH_DX_TO_MRC)
grid_dx.write_dx(PATH_DX_TO_DX)
