...
python3 volgrids smiffer $folder/all_interactions/tsc.pdb     -e $folder/all_interactions/tsc.chem
python3 volgrids smiffer $folder/all_interactions/tsc_noH.pdb -e $folder/all_interactions/tsc.chem
