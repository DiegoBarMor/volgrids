...
python3 volgrids smiffer $folder_few_frames/fse.pdb  -o $folder_few_frames -t $folder_few_frames/fse.xtc -s 43.66 38.12 36.13 12

### multiprocessing: should produce identical CMAP keys to the single-proc run above
python3 volgrids smiffer $folder_few_frames/fse.pdb  -o $folder_few_frames -t $folder_few_frames/fse.xtc -s 43.66 38.12 36.13 12 -n 4
