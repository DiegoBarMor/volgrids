...
python3 volgrids smiffer prot $fout/peptide.pdb         -o $fout
python3 volgrids smiffer rna  $fout/guanine.pdb         -o $fout
python3 volgrids smiffer rna  $fout/ribose_gua_no_h.pdb -o $fout -c $tmp_config_ignore_h
python3 volgrids smiffer rna  $fout/ribose_gua.pdb      -o $fout
python3 volgrids smiffer rna  $fout/uuu.pdb             -o $fout

python3 volgrids smiffer prot $fout/all_arg.pdb -o $fout
python3 volgrids smiffer prot $fout/all_asn.pdb -o $fout
python3 volgrids smiffer rna  $fout/all_cyt.pdb -o $fout
python3 volgrids smiffer rna  $fout/all_ump.pdb -o $fout
