...
python3 smiffer.py rna $folder_few_resids/7vki.pdb -o $folder_few_resids -t $folder_few_resids/7vki.xtc
python3 smiffer.py rna $folder_few_frames/fse.pdb  -o $folder_few_frames -t $folder_few_frames/fse.xtc -s 43.66 38.12 36.13 12 -a
