...
python3 volgrids smiffer rna  $fpdb/1akx.pdb  -o $fout -a $fapbs/1akx.pdb.mrc
python3 volgrids smiffer prot $fpdb/1bg0.pdb  -o $fout -a $fapbs/1bg0.pdb.mrc
python3 volgrids smiffer prot $fpdb/6e9a.pdb  -o $fout -a $fapbs/6e9a.pdb.mrc
python3 volgrids smiffer rna  $fpdb/7oax0.pdb -o $fout -a $fapbs/7oax0.pdb.mrc
